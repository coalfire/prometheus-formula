...
node_exporter_tarball:
  archive.extracted:
    ...
    - source: {{ prometheus.exporter.node.source }}/v{{ promethus.exporter.node.version }}/prometheus-{{ promethus.exporter.node.version }}.{{ prometheus.exporter.node.arch }}.tar.gz
